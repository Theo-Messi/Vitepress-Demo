import{_ as a,c as i,o as n,ae as l}from"./chunks/framework.BtEkjhVd.js";const o=JSON.parse('{"title":"Markdown 扩展示例","description":"","frontmatter":{},"headers":[],"relativePath":"markdown-examples.md","filePath":"markdown-examples.md"}'),p={name:"markdown-examples.md"};function e(t,s,h,k,r,d){return n(),i("div",null,s[0]||(s[0]=[l(`<h1 id="markdown-扩展示例" tabindex="-1">Markdown 扩展示例 <a class="header-anchor" href="#markdown-扩展示例" aria-label="Permalink to &quot;Markdown 扩展示例&quot;">​</a></h1><p>此页面演示了 VitePress 提供的一些内置 markdown 扩展。</p><h2 id="语法突出显示" tabindex="-1">语法突出显示 <a class="header-anchor" href="#语法突出显示" aria-label="Permalink to &quot;语法突出显示&quot;">​</a></h2><p>VitePress 提供由 <a href="https://github.com/shikijs/shiki" target="_blank" rel="noreferrer">Shiki</a> 提供支持的语法高亮功能，以及行高亮等附加功能：</p><p><strong>输入</strong></p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">\`\`\`js{4}</span></span>
